 ...
 * the measure pass.
 */
public class VariableLinearLayoutManager extends android.support.v7.widget.LinearLayoutManager {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public VariableLinearLayoutManager(Context context, int orientation, boolean reverseLayout) {
        super(context, orientation, reverseLayout);
        this.view = null;
    }

    @SuppressWarnings("UnusedDeclaration")
    public VariableLinearLayoutManager(RecyclerView view) {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public VariableLinearLayoutManager(RecyclerView view, int orientation, boolean reverseLayout) {
